# Install script for directory: /home/scm/projects/hdfthumbs/cpp
...
if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "hdf5thumbnail")
  if(EXISTS "$ENV{DESTDIR}/usr/bin/hdf5thumbnailer" AND
    ...
    file(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/bin/hdf5thumbnailer"
         RPATH "/usr/local/lib64")
  endif()
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/usr/bin/hdf5thumbnailer")
  if(CMAKE_WARN_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(WARNING "ABSOLUTE path INSTALL DESTINATION : ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  endif()
  if(CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
...
file(INSTALL DESTINATION "/usr/bin" TYPE EXECUTABLE FILES "/home/scm/projects/hdfthumbs/cpp/build/hdf5thumbnailer")
  if(EXISTS "$ENV{DESTDIR}/usr/bin/hdf5thumbnailer" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/bin/hdf5thumbnailer")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/bin/hdf5thumbnailer"
         ...
         NEW_RPATH "/usr/local/lib64")
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/bin/hdf5thumbnailer")
    endif()
  endif()
endif()
...
if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "hdf5thumbnail")
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/usr/share/thumbnailers/hdf5.thumbnailer")
  if(CMAKE_WARN_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(WARNING "ABSOLUTE path INSTALL DESTINATION : ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  endif()
  if(CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
...
file(INSTALL DESTINATION "/usr/share/thumbnailers" TYPE FILE FILES "/home/scm/projects/hdfthumbs/cpp/gnome/hdf5.thumbnailer")
endif()
...
file(WRITE "/home/scm/projects/hdfthumbs/cpp/build/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
